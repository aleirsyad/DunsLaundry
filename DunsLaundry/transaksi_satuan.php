...
$query = "SELECT * FROM pembayaran as p INNER JOIN satuan as sa ON p.satuan_id=sa.satuan_id WHERE p.customer_id = $id";
    ...
    <section>
        ...
        <div class="card">
            <div class="text-center pt-2 mb-5">
                <h2>Daftar Transaksi Laundry Satuan Duns Laundry</h2>
            </div>
